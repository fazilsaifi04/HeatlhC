        ...
        <Accordion className='my-5 subsection2' ref={accordionRef}>
          ...
          <Accordion.Item eventKey='1'>
            ...
            <Accordion.Body>
              ...
              HealthC provides you with easy-to-read charts and graphs that allow you to track your progress and monitor your health goals. With just a glance, you can see how your tablets info, doctor appointments, and medical history are affecting your overall health. Plus, our dashboard feature allows you to view your health data in a comprehensive and organized way, making it easy to identify areas for improvement and stay on top of your health.
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey='3'>
            ...
            <img alt='accordion image4' src="https://ik.imagekit.io/medpal/accordian4.webp?updatedAt=1683913602260" height={100} /> <br></br>
              HealthC provides easy access to a doctor's contact information, office hours, and directions. This allows you to plan your visit more efficiently and make the most of your time at the doctor's office.
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
      </div>
